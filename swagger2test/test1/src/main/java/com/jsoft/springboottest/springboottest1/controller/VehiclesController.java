...
public class VehiclesController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "page", value = "page", required = false, dataType = "int", paramType = "query",defaultValue = "1"),
            @ApiImplicitParam(name = "count", value = "count", required = false, dataType = "int", paramType = "query",defaultValue = "10")
    })
    @ApiResponses(value = {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "vno", value = "车牌", required = false, dataType = "string", paramType = "path", defaultValue = "辽A12345")
    })
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Successful — 请求已完成"),
            @ApiResponse(code = 400, message = "请求中有语法问题，或不能满足请求"),
    ...
    public ModelMap getVno(@PathVariable(value = "vno") String vno) throws Exception {
    ...
    public ModelMap getLocation(@PathVariable(value = "vno") String vno) throws Exception {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "id", required = false, dataType = "string", paramType = "path", defaultValue = "12344444")
    })
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Successful — 请求已完成"),
            @ApiResponse(code = 400, message = "请求中有语法问题，或不能满足请求"),
    ...
    public ModelMap getById(@PathVariable(value = "id") String id) throws Exception {
    ...
    public ModelMap delById(@PathVariable(value = "id") String id) throws Exception {
